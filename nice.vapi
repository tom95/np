...
namespace Nice {
	...
	public class Agent {
		...
		public bool get_local_credentials  (uint stream_id, out string user, out string pw);
		...
		public bool get_selected_pair (uint stream_id, uint component_id, out unowned Candidate lfoundation, out unowned Candidate rfoundation);
